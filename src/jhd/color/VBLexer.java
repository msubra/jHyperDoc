...
public class VBLexer extends antlr.CharScanner implements VBLexerTokenTypes, TokenStream
 {
public VBLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public VBLexer(Reader in) {
	this(new CharBuffer(in));
}
public VBLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public VBLexer(LexerSharedInputState state) {
	super(state);
