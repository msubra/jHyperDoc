// $ANTLR 2.7.2a2 (20020112-1): "ccpp.g" -> "CCPPLexer.java"$
...
public class CCPPLexer
	extends antlr.CharScanner
	implements CCPPLexerTokenTypes, TokenStream {
	public CCPPLexer(InputStream in) {
		this(new ByteBuffer(in));
	}
	public CCPPLexer(Reader in) {
		this(new CharBuffer(in));
	}
	public CCPPLexer(InputBuffer ib) {
		this(new LexerSharedInputState(ib));
	}
	public CCPPLexer(LexerSharedInputState state) {
		super(state);
	...
	public final void mBRACKETS(boolean _createToken)
	...
	public final void mOPERATORS(boolean _createToken)
		throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype;
		Token _token = null;
		int _begin = text.length();
